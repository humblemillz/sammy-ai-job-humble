  ...
  const proFeatures = [
    {
      ...
      description: "AI-powered analysis of opportunities to find the best matches for your profile"
    },
    {
      icon: Target,
      title: "Opportunities Matching & Recommendations",
      description: "Get personalized recommendations based on your skills, experience, and preferences"
    },
    {
      icon: BookOpen,
      title: "Step-by-Step Applications Support",
      description: "AI-guided application process with detailed instructions and best practices"
    },
    {
      icon: MessageSquare,
      title: "AI Career Tips",
      description: "Receive personalized career advice and tips to improve your applications"
    },
    {
      icon: Sparkles,
      title: "AI Career Counselling",
      description: "Get professional career guidance and strategic advice for your career path"
    },
    {
      icon: FileText,
      title: "Unlimited Documents",
      description: "Generate unlimited CVs, cover letters, SOPs, and other application documents"
    },
    {
      icon: Shield,
      title: "ATS-Optimized CV",
      description: "Get your CV optimized for Applicant Tracking Systems with AI assistance"
    },
    {
      icon: TrendingUp,
      title: "Cover Letters, SOPs & Reviews",
      description: "Professional document generation for all stages of your application process"
    }
  ];
